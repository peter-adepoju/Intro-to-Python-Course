...
2. Click `day21_tuples.ipynb` to open Day 21's notebook.

You can also open notebooks from the terminal:
```bash
jupyter notebook "Intro-to-Python-Course/Week_05/02_NOTEBOOKS/day21_tuples.ipynb"
```
...
Go to: `00_SCHEDULE/week_05_schedule.md`
